...
from core.match_strike import MatchStrikeEngine, MaxCutProblem, StrikeResult
from network.solver_node import TaskSpec, TaskResult
...
def test_verifier():
    ...
    from network.solver_node import SolverNode
