...
from network.spot_checker import SpotChecker, BatchCheckResult
from chain.cross_validator import CrossValidator
from chain.stats import BornRuleValidator
from network.reputation import ReputationSystem, ReputationEvent
from chain.dag import QuantumDAG, WorkUnit
from chain.finality import FinalityManager, Challenge
...
def demo_challenger():
    ...
    from core.match_strike import MatchStrikeEngine
