...
def test_adaptive_beats_random():
    ...
    from core.match_strike import MatchStrikeEngine, MaxCutProblem, classical_random_search
    from core.adaptive_controller import MultiScaleController
...
def test_verifier_catches_cheaters():
    ...
    from core.match_strike import MaxCutProblem
    from network.solver_node import SolverNode, TaskSpec
    from chain.verifier import Verifier, CheatingNode
...
def test_full_pipeline():
    ...
    from network.coordinator import Coordinator
    from network.solver_node import SolverNode, TaskSpec
    from chain.verifier import Verifier
